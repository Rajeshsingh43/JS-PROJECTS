...
function checkemail(email){
    if(email.length>8 && email.includes('@gmail')){
        ...
        document.getElementById('email_error').innerText='Email  must includes @gmail,8 letters long'
    }
}
function checkpassword(password){
    if(password.length>7  && password.includes('.')){
        ...
        document.getElementById('password_error').innerText='password must be 8 letters long and should includes .'
}
}
